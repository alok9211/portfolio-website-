          ...
          <div className='container mx-auto px-6 flex flex-col md:flex-row items-center justify-between'>
            <div className='md:w-1/2 mb-10 md:mb-0'>
                <h1 className='text-4xl md:text-6xl font-bold mb-4'>
                  Hi ,I'm <span className='text-purple-500'>Emma Watson</span>
                </h1>
                ...
                <div className='flex space-x-4'>
                    ...
                    <a href='#contact' className='px-6 py-3 border border-purple-300 rounded-lg font-medium hover:bg-purple-600 transition decoration-purple-300'>Contact Me</a>
                </div>
            </div>
             <div className='md:w-1/2 flex justify-center'>
                  <div className='relative w-64 h-64 md:w-80 md:h-80'>
                    <div className='basolute inset-0 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 animate-pulse-slow opacity-70'>
                        <motion.img 
                        animate={{y:[0,-20,0]}}
                        transition={{
                           duration:4,
